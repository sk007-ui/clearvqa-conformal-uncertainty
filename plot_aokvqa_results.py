...
def main():
    try:
        with open('cp_aokvqa_results.json', 'r') as f:
            data = json.load(f)
    except FileNotFoundError:
        print("Error: cp_aokvqa_results.json not found.")
        return
    ...
    # ── Identical styling to cp_comparison_plot and vcr_comparison_plot ──────────
    ...
    ax.set_title("Conformal Prediction Average Set Sizes\nClear vs. Ambiguous Images (A-OKVQA)", fontsize=16, fontweight='bold', pad=15)
    ...
    output_filename = "aokvqa_comparison_plot.png"
