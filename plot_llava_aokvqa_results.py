...
def main():
    try:
        with open('cp_llava_aokvqa_results.json', 'r') as f:
            data = json.load(f)
    except FileNotFoundError:
        print("Error: cp_llava_aokvqa_results.json not found.")
        return
    ...
    ax.set_title("Conformal Prediction Average Set Sizes\nClear vs. Ambiguous Images (LLaVA-1.5-7B, A-OKVQA)", fontsize=16, fontweight='bold', pad=15)
    ...
    output_filename = "llava_aokvqa_plot.png"
